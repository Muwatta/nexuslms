...
const heroBg = "linear-gradient(135deg,#1e3a5f 0%,#1e40af 50%,#312e81 100%)";
const dotPat = {
  backgroundImage:
      ...
      >
        ...
        <div className="relative max-w-6xl mx-auto flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-black text-white">Western School</h1>
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl text-sm font-semibold"
              style={{
                background: A.gold + "20",
                color: A.gold,
                border: `1px solid ${A.gold}35`,
              }}
            >
              📚 Courses
            </button>
        ...
        <div className="max-w-6xl mx-auto px-6 flex overflow-x-auto">
          {TABS.map((t) => (
            <button
              ...
              style={
                activeTab === t.id ? { borderColor: A.sky, color: A.sky } : {}
              }
            >
              {t.label}
            </button>
                    ...
                    {courses.slice(0, 8).map((c) => (
                      ...
                      >
                        ...
                        <span
                          ...
                          style={{ background: A.sky + "15", color: A.sky }}
                        >
                          Active
                        </span>
                      </div>
                  ...
                  <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
                    <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-800">
                      <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                        {list.length} {activeTab} in Western department
                      </p>
                    </div>
                    <table className="w-full text-sm">
                      ...
                      <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                        {list.map((p: any, i: number) => (
                          <tr
                            key={p.id}
                            className={`hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-colors ${i % 2 === 0 ? "bg-white dark:bg-slate-900" : "bg-slate-50/50 dark:bg-slate-800/20"}`}
                          >
                            ...
                            <td className="px-5 py-3">
                              <div className="flex items-center gap-3">
                                <div
                                  ...
                                  style={{
                                    background: `linear-gradient(135deg,${A.sky},${A.indigo})`,
                                  }}
                                >
                                  {(
                                    p.user?.first_name?.[0] ??
                ...
                <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
                  <div className="px-5 py-4 bg-gradient-to-r from-blue-700 to-blue-600">
                    ...
                    <p className="text-blue-100 text-xs mt-0.5">
                      Select class + term + session → load → publish to students
                    </p>
                  </div>
                  <div className="p-5 grid grid-cols-2 sm:grid-cols-4 gap-4">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3 py-2.5 border border-slate-300 dark:border-slate-600 rounded-xl text-sm dark:bg-slate-800 dark:text-white focus:ring-2 focus:ring-blue-500"
                      >
                        <option value="">— Select class —</option>
                        {WESTERN_CLASSES.map(([v, l]) => (
                    ...
                    <div className="flex items-end">
                      <button
                        ...
                        className="w-full px-4 py-2.5 bg-blue-700 hover:bg-blue-800 disabled:bg-slate-300 dark:disabled:bg-slate-700 text-white rounded-xl text-sm font-semibold flex items-center justify-center gap-2 transition-colors"
                      >
                        {pubLoading ? (
                          <>
                        ...
                        {canPublish > 0 ? (
                          <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 rounded-2xl p-5 flex flex-wrap items-center justify-between gap-4">
                            <div>
                              ...
                              <p className="text-sm text-amber-600 dark:text-amber-300 mt-0.5">
                                Scores visible to students immediately. Report
                          ...
                          <div className="bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-5 text-center">
                            ...
                            <p className="text-sm text-slate-400 mt-1">
                              Teachers must enter and submit, class teacher must
                              review
                            </p>
                          </div>
                        )}
