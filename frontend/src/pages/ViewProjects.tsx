            ...
            <button
              ...
              className={`px-4 py-2 rounded-full font-medium transition capitalize ${
                filterStatus === status
                  ...
                  : "bg-white dark:bg-gray-700 dark:text-purple-200 text-purple-700 border border-purple-200 dark:border-purple-700 hover:border-purple-500"
              }`}
            >
              {status === "all"
                ? `All (${projects.length})`
          ...
          <div className="space-y-4">
            {filteredProjects.map((project) => {
              ...
              return (
                <div
                  key={project.id}
                  className="bg-white dark:bg-gray-800 rounded-lg shadow hover:shadow-lg transition p-6 border-l-4 border-purple-500"
                >
