...
# ── Guard against double-registration (Django raises ImproperlyConfigured) ────
# If academic.py also registers Course, comment out @admin.register(Course) here
# and keep only one registration site.
...
class CourseAdmin(admin.ModelAdmin):
    ...
    actions = ["activate_courses", "deactivate_courses", "assign_department_from_instructor"]
    ...
    def department_display(self, obj):
        ...
        # Django 6 requires ALL format_html placeholders to use {} not positional
        return format_html(
    ...
    def display_instructor(self, obj):
        ...
        return format_html('<span style="color:#c62828">Not assigned</span>')
